...
(def threats[
             ...
             (threat. "A regulator investigates an infringement of the General Data Protection Regulation"
                      (likelihood. (list
                                    ...
                                    "Is it likely that someone may raise a complaint to the regulator about your organisation?"
             ...
             (threat. "An end user or third party tries to commit fraud by providing false information"
                      ...
                      ""),
             (threat. "A disgruntled or angry employee or ex-exployee tries to embarrass or hurt the organisation"
                      (likelihood. (list
             ...
             (threat. "An internal user tries to access sensitive information out of curiosity"
                      (likelihood. (list
                                    ...
                                    "Does the system store any sensitive data?"))
                      "")])
...
(defn draw-threat [card]
  [:div.bigcard
   ...
   [:ul
    (for [bullet (:bullets (:likelihood card))] [:li bullet])
    ]
   [:div.card-threat-subtitle "IMPACT"]
   [:div.card-threat-title (:impact card)]
   ]
  )
